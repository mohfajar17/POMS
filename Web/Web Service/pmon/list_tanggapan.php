<?php
	...
	if($_SERVER['REQUEST_METHOD'] == "POST"){
		...
		if($count>0){
			$sqlGetForm = "SELECT * FROM rekam_medis WHERE id_atlet = '".$row['id_atlet']."' and status_read = '".$row['status_read']."'";
			...
			if(mysqli_num_rows($qurGetForm) > 0){
		 	...
		 	$json = array("status" => 1, "msg" => "Get list tanggapan success!", "data" => $rowsForm);
		}else{
